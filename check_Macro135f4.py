...
def MacroLens(Nlens1=1.72, Nlens2=1.62, Nlens3=1.62, Nlens4=1.62, Nlens5=1.72,
            NBlueRay1=1.0, NBlueRay2=1.0, NBlueRay3=1.0, NBlueRay4=1.0, NBlueRay5=1.0):
...
# マクロレンズ,スクリーン上から逆伝播
def MacroLens_reverse(startZ=0):
    Nlens1=1.6
    Nlens2=1.53
    Nlens3=1.53
    Nlens4=1.53
    ...
    raySPoint = np.array([10.695, 0, startZ])  # 始点
...
# マクロレンズ焦点付近
def MacroLens_reverse_Screen(focus):
    MacroLens_reverse()
    ax.set_xlim(-LX*2+focus, LX*2+focus)  # 10.695 or 14.895
    ax.set_ylim(-LY*2, LY*2)
    ax.set_zlim(-LZ*2, LZ*2)
...
if __name__ == "__main__":
    ...
    MacroLens_reverse_Screen(10.695)
